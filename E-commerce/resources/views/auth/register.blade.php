                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3" style="display: none">
                            <label for="userType" class="col-md-4 col-form-label text-md-end">{{ __('Type d\'utilisateur') }}</label>
                            <div class="col-md-6">
                                <input id="userType" type="text" class="form-control @error('userType') is-invalid @enderror" name="userType" value="CLIENT" required autocomplete="userType" autofocus>
